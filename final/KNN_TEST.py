...
from sklearn.feature_selection import SelectKBest, f_regression,GenericUnivariateSelect
...
r2 = accuracy_score(yknn_bef_scaler,y_test)
mse = mean_squared_error(y_test, yknn_bef_scaler)

filename = "C:\\Users\\aiolb\\Desktop\\MLGame-beta8.0.1\\games\\pingpong\\ml\\1P.sav"
